...
class GoogleMap(Container):
	...
	fullscreen_control_options: GoogleMap.FullscreenControlOptions = field(default_factory=GoogleMap.FullscreenControlOptions)		#  The display options for the Fullscreen control.
	...
	map_type_control_options: GoogleMap.MapTypeControlOptions = field(default_factory=GoogleMap.MapTypeControlOptions)		#  The display options for the Map type control.
	map_type_id: GoogleMap.MapTypeId = field(default_factory=GoogleMap.MapTypeId)		#  The map type ID. Defaults to MapTypeId.ROADMAP
	...
	rotate_control_options: GoogleMap.RotateControlOptions = field(default_factory=GoogleMap.RotateControlOptions)		#  The display options for the rotate control.
	scale_control: Boolean = field(default_factory=Boolean)		#  The enabled/disabled state of the scale control.
	scale_control_options: GoogleMap.ScaleControlOptions = field(default_factory=GoogleMap.ScaleControlOptions)		#  The display options for the scale control.
	...
	street_view_control_options: GoogleMap.StreetViewControlOptions = field(default_factory=GoogleMap.StreetViewControlOptions)		#  The display options for the street view control.
	tag: ClassDict = field(default_factory=ClassDict)		#  Use this property to store any extra information about this component
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	...
	zoom_control_options: GoogleMap.ZoomControlOptions = field(default_factory=GoogleMap.ZoomControlOptions)		#  The display options for the zoom control.
	def close(self): 
