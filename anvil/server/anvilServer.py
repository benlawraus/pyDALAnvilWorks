...
def unwrap_capability(capability, scope_pattern):
    ...
    match, the scope must: - Be at least as broad as the pattern (ie the same length or shorter)- Contain the same
    values in the same position as the pattern - unless that position in the pattern is Capability.ANY, which matches
