...
class AbstractOverlay(anvil.Component):
	...
	parent: anvil.Container = field(default_factory=anvil.Container)		#  
...
class InfoWindow(anvil.Component):
	content: anvil.Component = field(default_factory=anvil.Component)		#  Content to display in the InfoWindow.
	...
	z_index: Number = field(default_factory=Number)		#  All InfoWindows are displayed on the map in order of their zIndex, with higher values displaying in front of InfoWindows with lower values.
	pass
...
class Polygon(AbstractOverlay):
	...
	fill_color: String = field(default_factory=String)		#  The color to draw the overlay outline.
	fill_opacity: Number = field(default_factory=Number)		#  The opacity of the overlay outline.
	geodesic: Boolean = field(default_factory=Boolean)		#  When true, edges of the polygon are interpreted as geodesic and will follow the curvature of the Earth.
	parent: anvil.Container = field(default_factory=anvil.Container)		#  
	path: List[LatLng] = field(default_factory=List[LatLng])		#  The ordered sequence of LatLng coordinates of the Polygon.
	stroke_color: String = field(default_factory=String)		#  The color to draw the overlay outline.
	stroke_opacity: Number = field(default_factory=Number)		#  The opacity of the overlay outline.
	stroke_position: StrokePosition = field(default_factory=StrokePosition)		#  The stroke position. Defaults to CENTER.
	stroke_weight: Number = field(default_factory=Number)		#  The weight of the overlay outline
...
class Polyline(AbstractOverlay):
	...
	parent: anvil.Container = field(default_factory=anvil.Container)		#  
	path: List[LatLng] = field(default_factory=List[LatLng])		#  The ordered sequence of LatLng coordinates of the Polyline.
	stroke_color: String = field(default_factory=String)		#  The color to draw the overlay outline.
	stroke_opacity: Number = field(default_factory=Number)		#  The opacity of the overlay outline.
	stroke_weight: Number = field(default_factory=Number)		#  The weight of the overlay outline
	pass
