...
class Button(Component):
	...
	icon: Icon = field(default_factory=Icon)		#  The icon to display on this component. Either a URL, or a FontAwesome Icon, e.g. ‘fa:user’.
	icon_align: String = field(default_factory=String)		#  The alignment of the icon on this component. Set to ‘top’ for a centred icon on a component with no text.
	...
	role: Themerole = field(default_factory=Themerole)		#  Choose how this component can appear, based on your app’s visual theme.
	...
	width: String = field(default_factory=String)		#  The width of this Button, or “default” to have the width set by the container.
	pass
...
class Canvas(Component):
	...
	global_composite_operation: Number = field(default_factory=Number)		#  The global composite operation to draw with. Defaults to ‘source-over’
	...
	tooltip: String = field(default_factory=String)		#  Text to display when you hover the mouse over this component
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this Canvas, or “default” to have the width set by the container.
...
class CheckBox(Component):
	...
	allow_indeterminate: Boolean = field(default_factory=Boolean)		#  Support an indeterminate state. The indeterminate state can only be set in code by setting checked=None.
	background: Color = field(default_factory=Color)		#  The background colour of this component.
	bold: Boolean = field(default_factory=Boolean)		#  Display this component’s text in bold
	border: String = field(default_factory=String)		#  The border of this component. Can take any valid CSS border value.
	...
	underline: Boolean = field(default_factory=Boolean)		#  Display this component’s text underlined
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this CheckBox, or “default” to have the width set by the container.
	def focus(self): 
...
class ColumnPanel(Container):
	...
	row_spacing: Pixels = field(default_factory=Pixels)		#  The spacing between rows of components in this container, in pixels.
	...
	width: String = field(default_factory=String)		#  The width of this ColumnPanel, or “default” to have the width set by the container.
...
class DataGrid(Container):
	auto_header: Boolean = field(default_factory=Boolean)		#  Whether to display an automatic header at the top of this Data Grid.
	background: Color = field(default_factory=Color)		#  The background colour of this component.
	border: String = field(default_factory=String)		#  The border of this component. Can take any valid CSS border value.
	...
	tooltip: String = field(default_factory=String)		#  Text to display when you hover the mouse over this component
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this DataGrid, or “default” to have the width set by the container.
...
class DataRowPanel(Container):
	...
	underline: Boolean = field(default_factory=Boolean)		#  Display this component’s text underlined
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this DataRowPanel, or “default” to have the width set by the container.
...
class DatePicker(Component):
	...
	parent: Container = field(default_factory=Container)		#  
	pick_time: Boolean = field(default_factory=Boolean)		#  Whether the user should be able to select a time as well as a date
	...
	underline: Boolean = field(default_factory=Boolean)		#  Display this component’s text underlined
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this DatePicker, or “default” to have the width set by the container.
	pass
...
class DropDown(Component):
	...
	font_size: Pixels = field(default_factory=Pixels)		#  The height of text displayed on this component in pixels
	foreground: Color = field(default_factory=Color)		#  The foreground colour of this component.
	include_placeholder: Boolean = field(default_factory=Boolean)		#  Whether to add a placeholder item to the list with value None
	italic: Boolean = field(default_factory=Boolean)		#  Display this component’s text in italics
	...
	role: Themerole = field(default_factory=Themerole)		#  Choose how this component can appear, based on your app’s visual theme.
	selected_value: Object = field(default_factory=Object)		#  The value of the currently selected item. Can only be set at runtime.
	spacing_above: String = field(default_factory=String)		#  The vertical space above this component.
	spacing_below: String = field(default_factory=String)		#  The vertical space below this component.
	tag: ClassDict = field(default_factory=ClassDict)		#  Use this property to store any extra information about this component
	tooltip: String = field(default_factory=String)		#  Text to display when you hover the mouse over this component
	underline: Boolean = field(default_factory=Boolean)		#  Display this component’s text underlined
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this DropDown, or “default” to have the width set by the container.
	def focus(self): 
		"""Set the keyboard focus to this component		"""
		pass
	pass
...
class FileLoader(Component):
	...
	border: String = field(default_factory=String)		#  The border of this component. Can take any valid CSS border value.
	enabled: Boolean = field(default_factory=Boolean)		#  True if this component should allow user interaction.
	file: Media = field(default_factory=Media)		#  The currently selected file (or the first, if multiple files are selected). This is a Media object.
	file_types: String = field(default_factory=String)		#  Specify what type of file to upload. Can accept a MIME type (eg “image/png” or “image/*“), or an extension (eg “.png”), or a comma-separated set of them (eg “.png,.jpg,.jpeg”)
	files: List[Media] = field(default_factory=List[Media])		#  A list of currently selected files. Each file is a Media object.
	font: String = field(default_factory=String)		#  The font to use for this component.
	font_size: Pixels = field(default_factory=Pixels)		#  The height of text displayed on this component in pixels
	foreground: Color = field(default_factory=Color)		#  The foreground colour of this component.
	icon: Icon = field(default_factory=Icon)		#  The icon to display on this component. Either a URL, or a FontAwesome Icon, e.g. ‘fa:user’.
	icon_align: String = field(default_factory=String)		#  The alignment of the icon on this component. Set to ‘top’ for a centred icon on a component with no text.
	italic: Boolean = field(default_factory=Boolean)		#  Display this component’s text in italics
	multiple: Boolean = field(default_factory=Boolean)		#  If True, this FileLoader can load multiple files at the same time
	parent: Container = field(default_factory=Container)		#  
	role: Themerole = field(default_factory=Themerole)		#  Choose how this component can appear, based on your app’s visual theme.
	...
	underline: Boolean = field(default_factory=Boolean)		#  Display this component’s text underlined
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this FileLoader, or “default” to have the width set by the container.
	def clear(self): 
...
class FlowPanel(Container):
	...
	tooltip: String = field(default_factory=String)		#  Text to display when you hover the mouse over this component
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this FlowPanel, or “default” to have the width set by the container.
...
class GoogleMap(Container):
	background_color: String = field(default_factory=String)		#  Color used for the background of the Map div. This color will be visible when tiles have not yet loaded as the user pans.
	center: anvilGoogleMap.LatLng = field(default_factory=anvilGoogleMap.LatLng)		#  The Map center.
	clickable_icons: Boolean = field(default_factory=Boolean)		#  When false, map icons are not clickable. A map icon represents a point of interest
	disable_default_ui: Boolean = field(default_factory=Boolean)		#  Enables/disables all default UI.
	disable_double_click_zoom: Boolean = field(default_factory=Boolean)		#  Enables/disables zoom and center on double click.
	draggable: Boolean = field(default_factory=Boolean)		#  If false, prevents the map from being dragged.
	draggable_cursor: String = field(default_factory=String)		#  The name or url of the cursor to display when mousing over a draggable map.
	dragging_cursor: String = field(default_factory=String)		#  The name or url of the cursor to display when the map is being dragged.
	fullscreen_control: Boolean = field(default_factory=Boolean)		#  The enabled/disabled state of the Fullscreen control.
	fullscreen_control_options: anvilGoogleMap.FullscreenControlOptions = field(default_factory=anvilGoogleMap.FullscreenControlOptions)		#  The display options for the Fullscreen control.
	gesture_handling: String = field(default_factory=String)		#  This setting controls how gestures on the map are handled.
	heading: Number = field(default_factory=Number)		#  The heading for aerial imagery in degrees measured clockwise from cardinal direction North.
	height: String = field(default_factory=String)		#  The height of this component.
	keyboard_shortcuts: Boolean = field(default_factory=Boolean)		#  If false, prevents the map from being controlled by the keyboard.
	map_data: anvilGoogleMap.Data = field(default_factory=anvilGoogleMap.Data)		#  Map data
	map_type_control: Boolean = field(default_factory=Boolean)		#  The enabled/disabled state of the Map type control.
	map_type_control_options: anvilGoogleMap.MapTypeControlOptions = field(default_factory=anvilGoogleMap.MapTypeControlOptions)		#  The display options for the Map type control.
	map_type_id: anvilGoogleMap.MapTypeId = field(default_factory=anvilGoogleMap.MapTypeId)		#  The map type ID. Defaults to MapTypeId.ROADMAP
	...
	rotate_control_options: anvilGoogleMap.RotateControlOptions = field(default_factory=anvilGoogleMap.RotateControlOptions)		#  The display options for the rotate control.
	scale_control: Boolean = field(default_factory=Boolean)		#  The enabled/disabled state of the scale control.
	scale_control_options: anvilGoogleMap.ScaleControlOptions = field(default_factory=anvilGoogleMap.ScaleControlOptions)		#  The display options for the scale control.
	scroll_wheel: Boolean = field(default_factory=Boolean)		#  If false, disables scrollwheel zooming on the map.
	spacing_above: String = field(default_factory=String)		#  The vertical space above this component.
	spacing_below: String = field(default_factory=String)		#  The vertical space below this component.
	street_view_control: Boolean = field(default_factory=Boolean)		#  The enabled/disabled state of the street view control.
	street_view_control_options: anvilGoogleMap.StreetViewControlOptions = field(default_factory=anvilGoogleMap.StreetViewControlOptions)		#  The display options for the street view control.
	tag: ClassDict = field(default_factory=ClassDict)		#  Use this property to store any extra information about this component
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this GoogleMap, or “default” to have the width set by the container.
	...
	zoom_control_options: anvilGoogleMap.ZoomControlOptions = field(default_factory=anvilGoogleMap.ZoomControlOptions)		#  The display options for the zoom control.
	def close(self): 
...
class GridPanel(Container):
	...
	tooltip: String = field(default_factory=String)		#  Text to display when you hover the mouse over this component
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this GridPanel, or “default” to have the width set by the container.
...
class Image(Component):
	background: Color = field(default_factory=Color)		#  The background colour of this component.
	border: String = field(default_factory=String)		#  The border of this component. Can take any valid CSS border value.
	display_mode: String = field(default_factory=String)		#  Determines how the image’s size should be adjusted to fit the size of this Image component
	foreground: Color = field(default_factory=Color)		#  The foreground colour of this component.
	height: String = field(default_factory=String)		#  The height of this component.
	...
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this Image, or “default” to have the width set by the container.
	pass
...
class Label(Component):
	...
	underline: Boolean = field(default_factory=Boolean)		#  Display this component’s text underlined
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this Label, or “default” to have the width set by the container.
	pass
...
class LinearPanel(Container):
	...
	tooltip: String = field(default_factory=String)		#  Text to display when you hover the mouse over this component
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this LinearPanel, or “default” to have the width set by the container.
...
class Plot(Component):
	...
	tooltip: String = field(default_factory=String)		#  Text to display when you hover the mouse over this component
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this Plot, or “default” to have the width set by the container.
...
class RadioButton(Component):
	...
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this RadioButton, or “default” to have the width set by the container.
...
class RepeatingPanel(Component):
	...
	tooltip: String = field(default_factory=String)		#  Text to display when you hover the mouse over this component
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this RepeatingPanel, or “default” to have the width set by the container.
...
class RichText(Container):
	...
	background: Color = field(default_factory=Color)		#  The background colour of this component.
	border: String = field(default_factory=String)		#  The border of this component. Can take any valid CSS border value.
	content: String = field(default_factory=String)		#  The content to render in this component, in the format specified by the ‘format’ property
	data: Object = field(default_factory=Object)		#  A dict of data or Components to populate the named content {slots}.
	enable_slots: Boolean = field(default_factory=Boolean)		#  If true {braces} in content define slots. If false, braces in content display normally.
	font: String = field(default_factory=String)		#  The font to use for this component.
	font_size: Pixels = field(default_factory=Pixels)		#  The height of text displayed on this component in pixels
	foreground: Color = field(default_factory=Color)		#  The foreground colour of this component.
	...
	tooltip: String = field(default_factory=String)		#  Text to display when you hover the mouse over this component
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this RichText, or “default” to have the width set by the container.
...
class Spacer(Component):
	...
	tooltip: String = field(default_factory=String)		#  Text to display when you hover the mouse over this component
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this Spacer, or “default” to have the width set by the container.
	pass

@dataclass
class TextArea(Component):
	align: String = field(default_factory=String)		#  Align this component’s text
	auto_expand: Boolean = field(default_factory=Boolean)		#  If true, the text area will expand vertically to fit its contents
	background: Color = field(default_factory=Color)		#  The background colour of this component.
	bold: Boolean = field(default_factory=Boolean)		#  Display this component’s text in bold
	border: String = field(default_factory=String)		#  The border of this component. Can take any valid CSS border value.
	enabled: Boolean = field(default_factory=Boolean)		#  True if this component should allow user interaction.
	...
	underline: Boolean = field(default_factory=Boolean)		#  Display this component’s text underlined
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this TextArea, or “default” to have the width set by the container.
	def focus(self): 
...
class TextBox(Component):
	...
	underline: Boolean = False		#  Display this component’s text underlined
	visible: Boolean = True		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this TextBox, or “default” to have the width set by the container.
	def focus(self): 
...
class Timer(Component):
	interval: Seconds = field(default_factory=Seconds)		#  The number of seconds between each tick. 0 switches the timer off.
	parent: Container = field(default_factory=Container)		#  
	pass
...
class XYPanel(Container):
	...
	tooltip: String = field(default_factory=String)		#  Text to display when you hover the mouse over this component
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	width: String = field(default_factory=String)		#  The width of this XYPanel, or “default” to have the width set by the container.
...
class YouTubeVideo(Component):
	...
	spacing_above: String = field(default_factory=String)		#  The vertical space above this component.
	spacing_below: String = field(default_factory=String)		#  The vertical space below this component.
	state: Object = field(default_factory=Object)		#  Get the current playback state of the video as a string. E.g. PLAYING
	tag: ClassDict = field(default_factory=ClassDict)		#  Use this property to store any extra information about this component
	visible: Boolean = field(default_factory=Boolean)		#  Should this component be displayed?
	volume: Object = field(default_factory=Object)		#  Get or set the current volume, from 0 - 100.
	width: String = field(default_factory=String)		#  The width of this YouTubeVideo, or “default” to have the width set by the container.
